...
VALUES
	('157875196366160022','皮蛋粥',0.01,39,'好吃的皮蛋粥','//fuss10.elemecdn.com/0/49/65d10ef215d3c770ebb2b5ea962a7jpeg.jpeg',0,11,'2017-03-28 19:39:15','2017-07-02 11:45:44'),
	...
	('164103465734242707','蜜汁鸡翅',0.02,982,'好吃','//fuss10.elemecdn.com/7/4a/f307f56216b03f067155aec8b124ejpeg.jpeg',0,22,'2017-03-30 17:11:56','2017-06-24 19:20:54');
...
create table `seckill_order_detail` (
    ...
    primary key (`detail_id`),
    key `idx_order_id` (`order_id`),
    unique key `uk_openid_productid` (`buyer_openid`,`product_id`)
);
